...
import {orderListSelector,orderLoadingSelector} from "../../../redux-Tollkit/selector";
...
function OrderList() {
  ...
  return (
    <div className="container">
      <div className="row">
        <div className={`${selectOrder ? "col-lg-7" : "col-lg-12"}`}>
            ...
            <>
              <table className="table table-striped">
                <thead className="table-primary">
                  <tr>
                    <th className="text-end align-middle">Order day</th>
                    ...
                    <th className="text-end align-middle">Action</th>
                  </tr>
                </thead>
                <tbody>
                  {orderList?.map((order) => (
                    <tr key={order.orderId}>
                      <td className="text-end align-middle">
                        {dayjs(Date(order.orderInfo.orderDate)).format("MMM DD YYYY")}
                      </td>
                      <td className="text-end align-middle">
        ...
        <div className="d-flex align-items-center justify-content-between border-bottom">
            <h5>Order Details</h5>
            <span className="btn-close" onClick={()=>setSelectOrder(null)}></span>
        </div>
        <div className=" my-2 border-bottom">
            ...
            <div className="d-flex justify-content-between mb-2">
                ...
                <span className="fw-bolder">
                    {`${selectOrder?.orderInfo?.shipping ? '$' : 'Free'}`}
                </span>
            </div>
            <div className="d-flex justify-content-between mb-2">
                <span>Total</span>
